 ...
 *
 * (c) Mohamed Camara GUEYE <katakeynii@gmail.com>
 *
 */

namespace IslamSn\GeneratorBundle\Command\Generator;
...
/**
 * Generates a CRUD Rest controller controller.
 *
 * @author  Mohamed Camara GUEYE <katakeynii@gmail.com>
 */
class RestControllerGenerator extends Generator
{
    ...
    protected function generateControllerClass($forceOverwrite)
    {
        ...
        $bundle = end( $namespace_array);
        $entityBundle = str_replace("Bundle", "", $bundle );
        $entityNamespace = implode('\\', $parts);
